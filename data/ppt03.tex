...
即至少含有一点同时属于~$\mathbb{A}$~和~$\mathbb{B}$~，该点的~Minkowski~差即为原点~$\bm{O}(0, 0)$。
    ...
    \frame{
      \frametitle{实验结果：静止场景与$k$-DOP树对比}
        \begin{figure}[htbp] 
        \subfloat[Bunny(4968个三角网格)\label{fig:exp:static:bunny}]
        {  
           \includegraphics[width=\fourgraphicswidth\textwidth,page=3]{staticcd.pdf}
        }
        \subfloat[Apple(8040个三角网格)\label{fig:exp:static:apple}]
        {  
            \includegraphics[width=\fourgraphicswidth\textwidth, page=4]{staticcd.pdf}
        } 
        \subfloat[HappyBuddha(50000个三角网格)\label{fig:exp:static:happyBuddha}]
        {  
     ...
     \frame{
      \frametitle{实验结果：静止场景与$k$-DOP树对比}
       \begin{figure}[!ht] 
          \centering
          \subfloat[Bunny(4968个三角网格)\label{fig:exp:static:k24:k46:bunny}]
          {  
             \includegraphics[width=\fourgraphicswidth\textwidth,page=12]{staticcd.pdf}
          }
          \subfloat[HappyBuddha(50000个三角网格)\label{fig:exp:static:k24:k46:happybuddha}]
          {  
     ...
     \begin{figure}[!ht] 
          \centering
          \subfloat[Bunny(4968个三角网格)\label{fig:exp:dynamic:m10:bunny}]
          {  
             \includegraphics[width=0.43\textwidth,page=7]{dynamiccd.pdf}
          }
          \subfloat[HappyBuddha(50000个三角网格)\label{fig:exp:dynamic:m10:happyBuddha}]
          {  
             \includegraphics[width=0.43\textwidth, page=14]{dynamiccd.pdf}
          }
          \subfloat[Hand(128314个三角网格)\label{fig:exp:dynamic:m10:hand}]
          {  
    ...
    \frame{
      \frametitle{实验结果：运动场景与$k$-DOP树对比}
         \begin{figure}[htbp] 
    \centering
    \subfloat[Bunny(4968个三角网格)\label{fig:exp:static:k24:k46:bunny:dynamic}]
    {  
       \includegraphics[width=\fourgraphicswidth\textwidth,page=11]{dynamiccd.pdf}
    }
    \subfloat[HappyBuddha(50000个三角网格)\label{fig:exp:static:k24:k46:happybuddha:dynamic}]
    {  
