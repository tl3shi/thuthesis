...
{  
   \includegraphics[width=0.43\textwidth,page=7]{dynamiccd.pdf}
}
%\subcaptionbox{Apple(8040个三角网格)\label{fig:exp:dynamic:m10:apple}}
%{  
%    \includegraphics[width=0.43\textwidth, page=8]{dynamiccd.pdf}
%}\linebreak %强制换行
\subcaptionbox{HappyBuddha(50000个三角网格)\label{fig:exp:dynamic:m10:happyBuddha}}
{  
   \includegraphics[width=0.43\textwidth, page=14]{dynamiccd.pdf}
}\linebreak %强制换行
\subcaptionbox{Dinosaur(80554个三角网格)\label{fig:exp:dynamic:m10:dinosaur}}
{  
   \includegraphics[width=0.43\textwidth, page=10]{dynamiccd.pdf}
}
\subcaptionbox{Hand(128314个三角网格)\label{fig:exp:dynamic:m10:hand}}
{  
   \includegraphics[width=0.43\textwidth, page=16]{dynamiccd.pdf}
}
