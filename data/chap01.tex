...
文献~\onlinecite{klosowski1998efficient}~中综合对比了~$k \in \{6,14,18,26\}$~的实验效果，得出~$k=18$~时能达到效率最优的结论，而文献~\onlinecite{zachmann1998rapid}~经过实验发现在~$k \in \{6,8,14\}$~中，从构造时间、性能和存储空间角度方面，$k=6$~与~$k=14$~时达到类似的实验结果，
